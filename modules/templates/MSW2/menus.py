...
class S3MainMenu(default.S3MainMenu):
    ...
    def menu(cls):
        ...
        #msw
        #current.menu_help(right=True),
        #current.menu_lang(right=True),
        #current.menu_gis(right=True),
        #current.menu_auth(right=True),
        #current.menu_admin(right=True),
    ...
    def menu_modules(cls):
        ...
        #
        # msw: testing original code from s3menus.py (plus homepage)
        #
        # ---------------------------------------------------------------------
        # Modules Menu
        ...
        print "msw: calling menu_modules(cls) in MSW2/menus.py"
        ...
        # Home (usualy) always 1st (commented because redundant/unnecessary)
        # msw (now NOT commented out)
        ...
        #
        # msw, temporarily shut off original DRK menues
        #
        if False:
    ...
    def menu_lang(cls):
        ...
        for language in s3.l10n_languages.items():
            ...
            menu_lang(
                ...
                # msw: first try to change a menu somehow ...
                #ML("Toni", translate=False, lang_code=2, lang_name="Freakhase")
            )
        return menu_lang
