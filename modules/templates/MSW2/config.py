...
def config(settings):
    ...
    settings.base.system_name = "FLR Dresden"
    settings.base.system_name_short = "FLRDD"

    # PrePopulate data
    #settings.base.prepopulate += ("MSW2", "default/users", "MSW2/Demo")

    # Theme (folder to use for views/layout.html)
    settings.base.theme = "MSW2"
    ...
    settings.cms.hide_index = False #msw
